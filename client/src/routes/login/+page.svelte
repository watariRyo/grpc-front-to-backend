  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div class="mx-auto max-w-lg rounded-lg border">
      <div class="flex flex-col gap-4 p-4 md:p-8">
        <div>
          <label for="userID" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">User ID</label>
          <input name="userID" bind:value={userID} class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
        </div>
        ...
        <button on:click|preventDefault={handleLogin} class="block rounded-lg bg-gray-800 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:text-base">Sign in</button>
      ...
      <div class="flex items-center justify-center bg-gray-100 p-4">
        ...
        <button class="text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700 ml-2" on:click={() => isLogin = !isLogin}>Sign Up</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div class="mx-auto max-w-lg rounded-lg border" >
      <div class="flex flex-col gap-4 p-4 md:p-8">
        ...
        <button on:click|preventDefault={handleSignUp} class="block rounded-lg bg-gray-800 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:text-base">Sign Up</button>
      ...
      <div class="flex items-center justify-center bg-gray-100 p-4">
        ...
        <button class="text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700 ml-2" on:click={() => isLogin = !isLogin}>Sign in</button>
      </div>
    </div>
  </div>
</div>
